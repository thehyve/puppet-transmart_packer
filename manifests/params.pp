class transmart_packer::params (
    ...
    String $keycloak_offline_token = lookup('transmart_packer::keycloak_offline_token', String, first, ''),
    ...
    if $keycloak_offline_token == '' {
        fail('No keycloak offline token specified. Please configure transmart_packer::keycloak_offline_token')
    }
